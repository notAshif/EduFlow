...
export default function EditWorkflowPage() {
    ...
    const addNode = (nodeType: string, label: string) => {
        const getDefaultConfig = (type: string) => {
            switch (type) {
                case "whatsapp-group": return { to: "+1234567890", message: "Hello from FlowX!", groupName: "Test Group" };
                ...
                case "attendance-track": return { threshold: 75, action: "alert" };
                case "assignment-create": return { title: "New Assignment", description: "Please complete by Friday", dueDate: new Date().toISOString().split('T')[0] };
                case "schedule-check": return { reminderMinutes: 15 };
